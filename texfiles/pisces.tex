...
%Therefore, a good understanding of how the coupled ocean-biogeochemical model 
...
Note that the covariance has also been computed over the entire simulated period and the resulting covariance is very close (not shown).
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.75] {compare_covariance_chl.png}
