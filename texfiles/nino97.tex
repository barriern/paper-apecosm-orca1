...
This section describes the response of the epipelagic community to El Nino conditions.
The focus will be laid on three El Nino events of our study period, the 1982, 1997 and 2014 events, which are the strongest El Niño event on records \citep{santosoDefiningCharacteristicsENSO2017}.
...
Left column of Fig\ref{fig:mean_ond97_ape} shows the October, November and December fish biomass anomalies averaged on the three El Nino years (colors), to which the climatological mean is superimposed (black contours). 
