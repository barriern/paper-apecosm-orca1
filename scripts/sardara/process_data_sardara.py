...
# Now we remove areas which are not identified from integers. I.e when the identifier has missing values
...
# Now we extract the data whose codes are in the Pacific domain:
