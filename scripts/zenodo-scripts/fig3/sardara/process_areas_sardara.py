...
datatemp = pd.read_csv('../../data/external/geographic_id_wkt.csv', sep=',')
datatemp
...
output_ds.to_csv('processed_sardara_areas_latmax_%d_lonmin_%d_lonmax_%d.csv' %(pacific_latmax, pacific_lonmin, pacific_lonmax))
